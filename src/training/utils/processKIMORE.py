		...
		for sub_class_name in sub_class_dir[class_idx]:
			...
			for individual in individuals:
				...
				for exercise in exercises:
					...
					label_df = pd.read_excel(labels_path, engine='openpyxl')
...
# Convert lists to numpy arrays
	...
	# Save to pickle
	with open(cleanPath + 'kimoreDataset.pkl', 'wb') as f:
		pickle.dump(kimoreDataset, f)
